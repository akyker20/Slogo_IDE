...
public class NotEqualTests extends CommandTester {
	@Test
	public void IntegerParseTest() throws SLOGOException {
		resetTesterVariables();
		setUpCommands("notequal? 50 50");
	...
	public void FloatParseTest() throws SLOGOException {
		resetTesterVariables();
		setUpCommands("notequal? 50.0 50.0");
		CommandParser parser = createCommand();
	...
	public void IntegerLongParseTest() throws SLOGOException {
		resetTesterVariables();
		setUpCommands("notequal? 50 notequal? 50 50");
		CommandParser parser = createCommand();
	...
	public void IntegerLongerParseTest() throws SLOGOException {
		resetTesterVariables();
		setUpCommands("notequal? 50 notequal? 1 notequal? 0 notequal? 50 notequal? 50 and 50 - 50 50");
		CommandParser parser = createCommand();
